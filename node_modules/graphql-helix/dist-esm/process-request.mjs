import { execute as defaultExecute, getOperationAST, parse as defaultParse, subscribe as defaultSubscribe, validate as defaultValidate, GraphQLError, } from "graphql";
import { stopAsyncIteration, isAsyncIterable, isHttpMethod } from './util/index.mjs';
import { HttpError } from './errors.mjs';
import { getRankedResponseProtocols } from './util/get-ranked-response-protocols.mjs';
...
export const validateDocument = (schema, document, validate, validationRules) => {
